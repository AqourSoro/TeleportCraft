...
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/test_furnace.png");
	private final InventoryPlayer player;
	private final TileEntityTestFurnace tileentity;
	
	public GuiTestFurnace(InventoryPlayer player, TileEntityTestFurnace tileentity) 
	{
		super(new ContainerTestFurnace(player, tileentity));
		this.player = player;
	...
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
	{
		...
		if(TileEntityTestFurnace.isBurning(tileentity))
		{
