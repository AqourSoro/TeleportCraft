package aqoursoro.teleportcraft.capability.teleporter;
...
public class CapabilityTeleportHandler
{
	...
	private static class EventHandler
	{
		...
		public void onAttachCapability(final AttachCapabilitiesEvent<Entity> event)
		{
			...
			{
				event.addCapability(new ResourceLocation(Reference.MOD_ID, "entity"), new CapabilityTeleportHandler.Provider());
			}
		}
