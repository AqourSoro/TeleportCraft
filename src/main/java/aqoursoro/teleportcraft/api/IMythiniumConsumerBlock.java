...
import aqoursoro.teleportcraft.capability.mythiniumenergy.IMythiniumEnergy;
import net.minecraft.tileentity.TileEntity;
import net.minecraft.util.EnumFacing;
import net.minecraft.util.math.BlockPos;
import net.minecraft.world.World;

public interface IMythiniumConsumerBlock extends IMythiniumConsumer
{
	...
	default boolean ConnectsTo(final EnumFacing side) 
	{
		...
		return tile.getCapability(CapabilityMythiniumEnergy.MYTHINIUM_ENERGY, side.getOpposite()) != null;
	}
	...
	default boolean canTransferEnergyTo(final EnumFacing side, final int energyToTransfer)
	{
		...
		final IMythiniumEnergy storage = getWorld().getTileEntity(getPosition().offset(side)).getCapability(CapabilityMythiniumEnergy.MYTHINIUM_ENERGY, side.getOpposite());
